About curio-feedstock
=====================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/curio-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=202&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/curio-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `curio` can be installed with `conda`:
...
It is possible to list all of the versions of `curio` available on your platform with `conda`:
...
```
mamba search curio --channel conda-forge
```
...
mamba repoquery search curio --channel conda-forge

# List packages depending on `curio`:
mamba repoquery whoneeds curio --channel conda-forge

# List dependencies of `curio`:
mamba repoquery depends curio --channel conda-forge
```
